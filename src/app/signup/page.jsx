    ...
    <div className='h-full grid place-items-center relative'>
      ...
      <div className="w-1/3">
        ...
        <form action="" className='flex flex-col gap-y-4'>
          ...
          <Button text="Create an account" onClick={onSignUp} className="w-full" />
        </form>

        <p className='font-semibold text-blue-900 text-sm mt-8'>Already have an account? <Link href={ROUTES.LOGIN} className='text-primary'>Log in</Link></p>
      </div>
    </div>
  )
}
